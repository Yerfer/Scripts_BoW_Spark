...
if __name__ == "__main__":
	...
	"""
	corpusRaw = sc.wholeTextFiles("hdfs://Master:9000/PROYECTO/DataSet")
	
	rta = commands.getstatusoutput('hdfs dfs -rm -R /PROYECTO/DataSetCore/KeysDocs/')
	...
	if rta[0] ==  0 or rta[0] ==  256:
		corpusRaw.keys().coalesce(1).saveAsTextFile("hdfs://Master:9000/PROYECTO/DataSetCore/KeysDocs")
